...
public class EntityODEnderman extends EntityMob
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(10, new EntityODEnderman.AIPlaceBlock(this));
        this.tasks.addTask(11, new EntityODEnderman.AITakeBlock(this));
        this.targetTasks.addTask(1, new EntityODEnderman.AIFindPlayer(this));
    ...
    static
    {
        ...
        CARRIABLE_BLOCKS_OLD.add(Blocks.DIAMOND_BLOCK);
        CARRIABLE_BLOCKS_OLD.add(Blocks.EMERALD_ORE);
        CARRIABLE_BLOCKS_OLD.add(Blocks.EMERALD_BLOCK);
        CARRIABLE_BLOCKS_OLD.add(Blocks.GOLD_ORE);
        CARRIABLE_BLOCKS_OLD.add(Blocks.GOLD_BLOCK);
        CARRIABLE_BLOCKS_OLD.add(Blocks.IRON_ORE);
        CARRIABLE_BLOCKS_OLD.add(Blocks.IRON_BLOCK);
        CARRIABLE_BLOCKS_OLD.add(Blocks.REDSTONE_ORE);
        CARRIABLE_BLOCKS_OLD.add(Blocks.REDSTONE_BLOCK);
        CARRIABLE_BLOCKS_OLD.add(Blocks.LOG);
        CARRIABLE_BLOCKS_OLD.add(Blocks.LEAVES);
        CARRIABLE_BLOCKS_OLD.add(Blocks.SPONGE);
        CARRIABLE_BLOCKS_OLD.add(Blocks.GLASS);
        CARRIABLE_BLOCKS_OLD.add(Blocks.LAPIS_ORE);
    ...
    {
        private final EntityODEnderman enderman;
        /** The player */
        private EntityPlayer player;
        private int aggroTime;
        private int teleportTime;

        public AIFindPlayer(EntityODEnderman p_i45842_1_)
        {
        ...
        public boolean shouldExecute()
        {
            ...
            this.player = this.enderman.worldObj.getNearestAttackablePlayer(this.enderman.posX, this.enderman.posY, this.enderman.posZ, d0, d0, (Function<EntityPlayer, Double>)null, new Predicate<EntityPlayer>()
            {
                ...
                {
                    return p_apply_1_ != null && EntityODEnderman.AIFindPlayer.this.enderman.shouldAttackPlayer(p_apply_1_);
                }
            });
    ...
    static class AIPlaceBlock extends EntityAIBase
    {
        ...
        public AIPlaceBlock(EntityODEnderman p_i45843_1_)
        {
    ...
    static class AITakeBlock extends EntityAIBase
    {
        ...
        public AITakeBlock(EntityODEnderman p_i45841_1_)
        {
        ...
        public void updateTask()
        {
            ...
            {
                if (EntityODEnderman.CARRIABLE_BLOCKS.contains(block) && flag)
                {
                    this.enderman.setHeldBlockState(iblockstate);
                    world.setBlockToAir(blockpos);
                }
