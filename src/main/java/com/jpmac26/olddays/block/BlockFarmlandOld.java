package com.jpmac26.olddays.block;
...
public class BlockFarmlandOld extends Block
{
    ...
    {
        if (ActionSettings.oldCropBreaking && !worldIn.isRemote && worldIn.rand.nextInt(4) == 0)
        {
